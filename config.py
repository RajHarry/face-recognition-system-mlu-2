...
PROCESSED_VIDEO_VERIFY_SAVE_LOC = f'{ROOT_DIR}/data/verify/videos'
...
VERIFY_VIDEOSTREAM_LOC = 'data/raw-videos/Rohan_reg_1.mov' # 'webcam' -> webcam, 'name.mp4' -> pre-recorded video
### Face Detection
FACE_DETECTION_MODEL_TYPE = 'cascade'
